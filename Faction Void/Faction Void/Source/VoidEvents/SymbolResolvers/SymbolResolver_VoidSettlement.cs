...
{
	public class SymbolResolver_VoidSettlement : SymbolResolver
	{
		...
		public override void Resolve(ResolveParams rp)
		{
			...
			BaseGen.symbolStack.Push("voidOutdoorLighting", rp);
			...
			if (num > 0)
			{
				...
				BaseGen.symbolStack.Push("voidEdgeDefense", resolveParams3);
			}
